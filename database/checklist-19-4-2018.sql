...
CREATE TABLE `checklists` (
  ...
  `checklist_name` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `checklist_overview` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `checklist_description` text CHARACTER SET utf8,
  `checklist_slug` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `checklist_image` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `checklist_files` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `checklist_status` tinyint(4) DEFAULT NULL,
...
INSERT INTO `checklists` (`checklist_id`, `user_id`, `user_email`, `user_full_name`, `category_id`, `checklist_name`, `checklist_overview`, `checklist_description`, `checklist_slug`, `checklist_image`, `checklist_files`, `checklist_status`, `created_at`, `updated_at`) VALUES
